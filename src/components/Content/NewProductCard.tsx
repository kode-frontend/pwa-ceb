...
export function NewProductCard() {
  ...
  return (
    <div
      className="bg-[#ffffff] box-border content-stretch flex flex-col items-start justify-start overflow-clip p-0 relative rounded-3xl shrink-0 w-full cursor-pointer"
      onClick={handleBack}
    >
